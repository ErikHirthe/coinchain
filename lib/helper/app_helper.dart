...
Color getNumberColor(dynamic number) =>
    isNegativeNum(number) ? Colors.red : Colors.green;
...
List getHistoryTypeData(String type) {
  switch (type) {
    ...
    case HistoryType.userTrade:
      return ["Trade History", Colors.blue];
  }
  return [];
}
...
// List getGiftStatusData(int? status) {
//   switch (status) {
//     case GiftCardStatus.active:
//       return ["Active".tr, Colors.amber];
//     case GiftCardStatus.redeemed:
//       return ["Redeemed".tr, Colors.amber];
//     case GiftCardStatus.transferred:
//       return ["Transferred".tr, Colors.green];
//     case GiftCardStatus.trading:
//       return ["Trading".tr, Colors.green];
//     case GiftCardStatus.locked:
//       return ["Locked".tr, Colors.redAccent];
//   }
//   return ["", Get.theme.primaryColor];
// }

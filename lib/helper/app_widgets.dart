...
Widget signInNeedView({bool isDrawer = false}) {
  ...
  return Padding(
    ...
    child: SizedBox(
      height: isDrawer ? Dimens.heightSlide : getContentHeight(withBottomNav: true, withToolbar: true) - 100,
      child: Column(
        mainAxisAlignment: MainAxisAlignment.center,
        children: [
...
Widget dropdownSuffix(Widget suffix, {double width = 100, MainAxisAlignment mainAxisAlignment = MainAxisAlignment.start}) {
  return SizedBox(
    width: width,
    child: Row(
        ...
        children: [
          ...
          Expanded(
            child: Row(
              ...
              children: [
                Expanded(child: AutoSizeText(text, style: Get.textTheme.bodyMedium, maxLines: 2, textAlign: TextAlign.end)),

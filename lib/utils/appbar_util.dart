...
AppBar appBarBackWithActions({String? title, List<String>? actionIcons, Function(int)? onPress, double? fontSize}) {
  return AppBar(
      ...
      title: textAutoSizeTitle(title ?? "", fontSize: fontSize ?? Dimens.titleFontSizeSmall),
...
TabBar tabBarUnderline(List<String> titles, TabController? controller,
    {Function(int)? onTap, bool isScrollable = false, TabBarIndicatorSize indicatorSize = TabBarIndicatorSize.tab}) {
  return TabBar(

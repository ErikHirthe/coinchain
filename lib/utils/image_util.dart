...
//                 width: width,
//                 height: height,
//                 colorFilter: _getColorFilter(iconColor),
//                 placeholderBuilder: (context) => SvgPicture.asset(AssetConstants.icLogo, colorFilter: _getColorFilter(iconColor)),
//               )
//             : Image.network(
//                 imagePath,
//                 fit: boxFit,
...
//                 },
//               )
//         : ClipOval(child: Container(height: height, width: width, color: Colors.grey, child: SvgPicture.asset(AssetConstants.icLogo))),
//   );
// }

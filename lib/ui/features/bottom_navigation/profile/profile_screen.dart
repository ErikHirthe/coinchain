...
class _ProfileScreenState extends State<ProfileScreen> {
      ...
      child: ListView(
        ...
        children: [
          Align(
            ...
            child: textAutoSizePoppins("Profile Information".tr,
            ...
            child: Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  vSpacer10(),
                  textAutoSizeTitle(getName(user.firstName, user.lastName),
                      fontSize: Dimens.regularFontSizeLarge),
                  textAutoSizePoppins(user.email ?? "",
          ...
          textFieldWithSuffixIcon(
              controller: TextEditingController(),
              text:
                  user.countryName.isValid ? user.countryName : "No Country".tr,
              hint: "Country".tr,
              isEnable: false),
          vSpacer10(),
          textFieldWithSuffixIcon(
              controller: TextEditingController(),
              text: getUserStatus(user.status),
              hint: "Status".tr,
              isEnable: false),
          vSpacer10(),
          textFieldWithSuffixIcon(
              controller: TextEditingController(),
              text: user.phone ?? "No Phone".tr,
              hint: "Phone".tr,
              isEnable: false),
          vSpacer30(),
  ...
  Widget _userActivityListView() {
    if (userActivities.isEmpty)
      _controller.getUserActivities((list) => userActivities = list);
    return Column(children: [
      Align(
        alignment: Alignment.centerLeft,
        child: textAutoSizePoppins("Profile Activity".tr,
            fontSize: Dimens.regularFontSizeExtraMid),
      ),
      vSpacer20(),
      ...
      userActivities.isEmpty
          ? vSpacer0()
          : Column(
              children: List.generate(userActivities.length,
                  (index) => _userActivityItem(userActivities[index]))),
      vSpacer20(),
    ]);
  }
      ...
      child: Row(
        ...
        children: [
          Expanded(
              flex: 1,
              child:
                  textAutoSizePoppins("Action".tr, textAlign: TextAlign.start)),
          Expanded(flex: 1, child: textAutoSizePoppins("IP Address".tr)),
          Expanded(
              flex: 1,
              child: textAutoSizePoppins("Time".tr, textAlign: TextAlign.end)),
        ],
      ),
    );
  }
    ...
    return Padding(
      ...
      child: Row(
        children: [
          Expanded(
              flex: 1,
              child: textAutoSizePoppins(actionString,
                  maxLines: 2, textAlign: TextAlign.start)),
          Expanded(
              flex: 1,
              child:
                  textAutoSizePoppins(activity.ipAddress ?? "", maxLines: 2)),
          Expanded(
              flex: 1,

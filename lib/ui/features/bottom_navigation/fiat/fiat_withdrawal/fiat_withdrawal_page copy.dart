    ...
    return Expanded(
      child: SingleChildScrollView(
        child: Padding(
          ...
          child: Column(
            children: [
              twoTextSpace("Amount".tr, "Select Wallet".tr,
              ...
              vSpacer30(),
              twoTextSpace("Convert Price".tr, "Select Currency".tr,
                  color: context.theme.primaryColor),
              vSpacer5(),
              // textFieldWithWidget(
              ...
              Obx(() {
                final fee =
                    "${"Fees".tr}: ${currencyFormat(_controller.fiatWithdrawalRate.value.fees)}";
                final netAmount =
                ...
                return twoTextSpaceFixed(fee, netAmount,
                    color: context.theme.primaryColor);
              }),
              vSpacer30(),
              ...
              Obx(
                () => dropDownListIndex(
                    _controller
                        .getBankList(_controller.fiatWithdrawalResp.value),
                    _controller.selectedBankIndex.value,
                    "Select Bank".tr, (index) {
              ...
              //     onPressCallback: () => _controller.checkInputData(context,))
            ],
          ),
        ),
      ),

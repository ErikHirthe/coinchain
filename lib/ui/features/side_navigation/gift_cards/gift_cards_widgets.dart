    ...
    return InkWell(
      ...
      child: Container(
        ...
        child: Column(
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            showImageNetwork(imagePath: gCard.banner?.image, width: cWidth, boxFit: BoxFit.fitWidth),
            vSpacer5(),
            textAutoSizeKarla(gCard.banner?.title ?? "", textAlign: TextAlign.start, fontSize: Dimens.regularFontSizeMid),
            vSpacer5(),
            textAutoSizePoppins(gCard.banner?.subTitle ?? "", textAlign: TextAlign.start, maxLines: 3)
          ],
        ),
      ),
    );

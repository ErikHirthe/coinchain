...
class HistoryType {
  ...
  static const userTrade = "user_trade";
  static const userMining = "user_mining";
}
...
class ListConstants {
  ...
  static const List<String> stopLimitList = [
    'Stop-limit',
    'limit',
    'market',
    'OCO'
  ...
  static const List<String> decimalPointList = [
    '0.01',
    '0.1',
    '1',
    '10',

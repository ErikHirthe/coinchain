...
class Strings extends Translations {
  ...
  Map<String, Map<String, String>> get keys => {
        'en': {
          ...
          "kOnBoardingDescription_0":
              "Magna ut amet, posuere eget. Conseq uat turpis tellus, massa malesuada phasellus ut in commodo. ",
          ...
          "Enter verification code which sent email":
              "Enter the verification code which was sent to your email",
          "Enter verification code which sent phone":
              "Enter the verification code which was sent to your phone",
          "Return to": "Return to",
          ...
          "Please enter the email address to request a password reset.":
              "Please enter the email address to request a password reset.",
          "Verify": "Verify",
          "Lorem ipsum dolor sit amet quam a sit suscipit non Lorem ipsum.":
              "Lorem ipsum dolor sit amet quam a sit suscipit non Lorem ipsum.",
          ...
          "code_invalid_message":
              "Code must be at least @count characters in length",
          ...
          "Back to": "Back to",
          "Sign In to unlock":
              "Please Sign In To Your Account and enjoy more exciting features.",
          "Log out": "Log Out",
          ...
          "stop value must be less than limit":
              "Stop value must be less than Limit",
          "5m": "5m",
          "15m": "15m",
          "30m": "30m",
          ...
          "Learn and earn_subtitle":
              "Stacks is a production-ready library of stackable content blocks built in React Native.",
          "Learn and earn_subtitle2":
          ...
          "withdraw_Max_min_fees":
              "Fees @fee@sign, Min withdraw @min Max withdraw @max",
          ...
          "Please setup your google 2FA":
              "Please setup your google 2FA for this process from settings page",
          ...
          "add phone number message":
              "Please add phone number with country dial code without plus(+) sign.",
          "Country": "Country",
          ...
          "Account holder name required":
              "The account holder's name is required",
          "Account holder address required":
              "The account holder's address is required",
          ...
          "Clear all": "Clear all",
          "empty_message_notifications_list":
          ...
          "Referrals": "Referrals",
          "empty_message_reference_list":
              "Your reference list will appear here",
          ...
          "Proceed": "Proceed",
          "You need to activate 2FA from settings for proceed this":
              "You need to activate 2FA from settings for proceed this",
          "Select Wallet": "Select Wallet",
          ...
          "Search": "Search",
          "Please Check Internet Connection and Run the App Again":
              "Please Check Internet Connection and Run the App Again",
          ...
          "Google Authenticator remove message":
              "Open your Authenticator app and enter the code for remove current 2FA.",
          ...
          "2fa authenticator code input message":
          ...
          "Do you want to cancel your Investment":
              "Do you want to cancel your Investment",
          ...
          "I agree to the terms and conditions":
              "I agree to the terms and conditions",
          "Confirm": "Confirm",
          "staking_holding_amount_terms":
              "You must have at least @value in your account",
          "staking_registered_before_terms":
              "You must have registered before @value",
          "staking_verified_phone_terms": "You must have verified phone number",
          "staking_verified_kyc_terms":

...
SwapHistory swapHistoryFromJson(String str) =>
    SwapHistory.fromJson(json.decode(str));
...
class SwapHistory {
  ...
  factory SwapHistory.fromJson(Map<String, dynamic> json) => SwapHistory(
        ...
        swapHistoryFromWallet: json["from_wallet"] == null
            ? null
            : Wallet.fromJson(json["from_wallet"]),
        swapHistoryToWallet: json["to_wallet"] == null
            ? null
            : Wallet.fromJson(json["to_wallet"]),
      );
  ...
  Map<String, dynamic> toJson() => {
        ...
        "toWallet": toWallet,
        "from_wallet": swapHistoryFromWallet == null
            ? null
            : swapHistoryFromWallet!.toJson(),
        "to_wallet":
            swapHistoryToWallet == null ? null : swapHistoryToWallet!.toJson(),
      };
}

/// final fiatDepositHistory = fiatDepositHistoryFromJson(jsonString);
List<FiatHistory> fiatDepositHistoryFromJson(String str) =>
    List<FiatHistory>.from(
        json.decode(str).map((x) => FiatHistory.fromJson(x)));

String fiatDepositHistoryToJson(List<FiatHistory> data) =>
    json.encode(List<dynamic>.from(data.map((x) => x.toJson())));
